        ...
        <div class="flex flex-1 w-full">
            ...
            <aside id="memberSidebar"
                ...
                @php
                    ...
                    $isAktif = $aktifHingga && ($aktifHingga->isFuture() || $aktifHingga->isToday());
                @endphp
    ...
    @else
        <div class="flex items-center justify-between px-4 py-2.5 rounded-lg text-gray-500 bg-white/5 cursor-not-allowed group relative">
            ...
            {{-- Tooltip mungil --}}
            <span class="absolute left-full ml-2 px-2 py-1 bg-rose-500 text-white text-[10px] rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50">
                Member Tidak Aktif
            </span>
        </div>
    @endif
