    ...
    <header class="w-full bg-[#e9ed81] shadow-md sticky top-0 z-40">
        ...
        <nav id="mobileNav"
            ...
            <div class="max-w-7xl mx-auto px-4 py-3 space-y-2">
                <a href="/" class="block {{ request()->is('/') ? 'text-emerald-700 font-semibold' : 'text-gray-900' }}">Home</a>
                <a href="/pricelist" class="block {{ request()->is('pricelist') ? 'text-emerald-700 font-semibold' : 'text-gray-900' }}">Pricelist</a>
                <a href="/trainer" class="block {{ request()->is('trainer') ? 'text-emerald-700 font-semibold' : 'text-gray-900' }}">Personal Trainer</a>
                <a href="/about" class="block {{ request()->is('about') ? 'text-emerald-700 font-semibold' : 'text-gray-900' }}">Tentang Kami</a>
                <a href="/login" class="block text-gray-900">Login</a>
            </div>
        </nav>
    </header>
