...
{{-- NOTIFIKASI PERPANJANGAN MEMBER --}}
@if($showRenewalNotice)
<div class="mb-8 p-4 md:p-5 rounded-2xl bg-rose-500/10 border border-rose-500/20 flex items-start gap-4 animate-pulse">
    <div class="shrink-0 w-10 h-10 rounded-full bg-rose-500/20 flex items-center justify-center text-rose-500">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
        </svg>
    </div>
    <div class="flex-1">
        <h3 class="text-sm md:text-base font-bold text-rose-400 uppercase tracking-tight">Keanggotaan Tidak Aktif</h3>
        <p class="text-xs md:text-sm text-gray-300 mt-1">
            Masa berlaku keanggotaan Anda telah berakhir atau belum diaktifkan. Silakan hubungi Admin di meja resepsionis untuk melakukan perpanjangan member agar tetap bisa mencatat progres latihan Anda.
        </p>
    </div>
</div>
@endif
